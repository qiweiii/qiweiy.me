...
function Home(props) {
  ...
  return (
      ...
      <Paper elevation='10' className={classes.paper}>
        ...
        <Typography gutterBottom variant='body1' className={classes.p}>Penultimate year Computer Science student from UNSW Sydney / Part-time Developer <br />with an interest in web technologies, cloud platforms and data management </Typography>
