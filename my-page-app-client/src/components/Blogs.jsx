    ...
    return (
      <div>
        ...
        {this.props.userBlogsReady ? (
          <div>{this.renderBlogs(this.processBlogs(this.props.userBlogs))}</div>
        ) : (
          <div className={classes.spinner}>
            <CircularProgress />
          </div>
...
export default connect(mapStateToProps, { getUserBlogs, setListSwitch, setFilter })(withStyles(styles)(Blogs))
